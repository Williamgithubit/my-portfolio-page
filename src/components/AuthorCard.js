        ...
        <>
         ...
         <div id="intro" class="bg-[#
              ...
              <div id="content" class="prose lg:prose-xl px-2">
                <h1 class="text-center text-gray-800 text-4xl capitalize font-medium">William T. Johnson Jr</h1>
                <small class="text-center block text-md text-gray-800">Learner, Teacher &amp; Software Engineer</small>
